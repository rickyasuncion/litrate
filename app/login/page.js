  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        -- GitHub Login Button --
        <button onClick={handleGitSignIn} className="w-full flex items-center justify-center px-4 py-2 bg-black text-white border border-gray-800 rounded-lg shadow-sm hover:bg-gray-800">
          <Image
            src="/github.png"
            width={20}
            height={20}
